...
function CircelCollision(p1x, p1y, r1, p2x, p2y, r2){
    let radiusSum;
    let xDiff;
    let yDiff;
    radiusSum = r1 +r2;
...
function Render() {
    ...
    if(asteroids.length !== 0){
        for(let k = 0; k < asteroids.length; k++){
            if(CircelCollision(ship.x, ship.y, 11, asteroids[k].x, asteroids[k].y, asteroids[k].collisionRadius)){
...
loop1: 
        for(let l =0; l < asteroids.length; l++){
            for(let m = 0; m < bullets.length; m++){
                if(CircelCollision(bullets[m].x, bullets[m].y, 3, asteroids[l].x, asteroids[l].y, asteroids[l].collisionRadius)){
